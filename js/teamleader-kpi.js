document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('add-team-leader-btn').addEventListener('click', () => addEntry('team_leaders', teamLeaderTemplate, teamLeaderContainer));
    ...
    async function loadAllData() {
        const collectionsToLoad = {
            team_leaders: { template: teamLeaderTemplate, container: teamLeaderContainer },
        };
